    ...
    return (
        ...
        >
            <div className="mb-14 text-center max-w-2xl mx-auto">
                <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-ink mb-4">Choose Your Canvas</h2>
                <p className="text-lg text-ink-light font-medium">
                ...
                {cities.map((city) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={`group relative h-[450px] w-full bg-white text-left cursor-pointer transition-all rounded-[2.5rem] overflow-hidden shadow-xl
                ${isSelected ? 'ring-4 ring-brand shadow-brand/20' : 'shadow-ink/5 hover:shadow-2xl hover:shadow-ink/10'}
              `}
                        >
                            <img
                                src={city.image}
                    ...
                    <div className="flex items-center gap-5">
                        <div className="flex -space-x-3">
                            {selectedCities.length === 0 ? (
                                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-ink-light shadow-inner border border-gray-100">
